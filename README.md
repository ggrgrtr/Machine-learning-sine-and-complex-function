...
Для определения классов вин использовались входной нейронный слой с двумя входами, выходной нейронный слой с 3 выходами (3 класса вин) и SoftMax от PyTorch, вычисляющий вероятность наследования объектом конкретного класса
